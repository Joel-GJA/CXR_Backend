...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Meteor shower — falling background */}
      <Meteors number={36} minDelay={0.1} maxDelay={2.5} minDuration={3} maxDuration={10} className="bg-cyan-300 shadow-[0_0_0_1px_#06b6d420]" />
